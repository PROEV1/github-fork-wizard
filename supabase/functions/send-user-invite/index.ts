...
const handler = async (req: Request): Promise<Response> => {
  ...
  try {
    ...
    const inviteUrl = `${Deno.env.get('SUPABASE_URL')}/auth/v1/verify?token=${inviteToken}&type=invite&redirect_to=${encodeURIComponent('https://preview--pro-spaces-client-portal.lovable.app/auth')}`;
